...
public class ElasticSearchHandler {
    ...
    /***
     * @param typeUrl "http://username:password@ip:9200/test/angel4/_mapping"
     * @param typeDdl "{\"angel4\":{\"properties\":{\"created\":{\"type\":\"multi_field\",\"fields\":{\"created\":{\"type\":\"string\"},\"date\":{\"type\":\"date\"}, \"shop_full_name\":{\"type\":\"string\", \"index\":\"not_analyzed\"}}}}}}"
     */
    public void createType(String typeUrl, String typeDdl) throws IOException {
        ...
        CloseableHttpClient httpclient = HttpClients.createDefault();
        CloseableHttpResponse response = httpclient.execute(request);
//        System.out.println(response); // HttpResponseProxy{HTTP/1.1 200 OK [Content-Type: application/json; charset=UTF-8, Content-Length: 21] ResponseEntityProxy{[Content-Type: application/json; charset=UTF-8,Content-Length: 21,Chunked: false]}}
        httpclient.close();
    }
